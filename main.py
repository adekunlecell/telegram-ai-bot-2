...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Yo! I'm your AI sidekick for all things crypto & gaming. Let's chat 💬🎮💸")
...
async def crypto_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if response.status_code == 200:
        ...
        if symbol in data:
            ...
            await update.message.reply_text("❌ Invalid symbol. Try something like btc or eth.")
    else:
